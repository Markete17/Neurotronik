Node x1a = new Node(layerController);
        ...
        x1az.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x1az.add(new MaxPooling2D(new PoolSize(2,2)));
        x1az.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x1bz.add(new Input(32,32,20));
        x1bz.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x1bz.add(new MaxPooling2D(new PoolSize(2,2)));
        x1bz.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x2z.add(new Input(32,32,20));
        x2z.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x2z.add(new MaxPooling2D(new PoolSize(2,2)));
        x2z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));
        x2z.add(new MaxPooling2D(new PoolSize(2,2)));
        x2z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x3z.add(new Input(32,32,20));
        x3z.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x3z.add(new MaxPooling2D(new PoolSize(2,2)));
        x3z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));
        x3z.add(new MaxPooling2D(new PoolSize(2,2)));
        x3z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x4z.add(new Input(32,32,20));
        x4z.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x4z.add(new MaxPooling2D(new PoolSize(2,2)));
        x4z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));
        x4z.add(new MaxPooling2D(new PoolSize(2,2)));
        x4z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x5z.add(new Input(32,32,20));
        x5z.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x5z.add(new MaxPooling2D(new PoolSize(2,2)));
        x5z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));
        x5z.add(new MaxPooling2D(new PoolSize(2,2)));
        x5z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x6z.add(new Input(32,32,20));
        x6z.add(new Conv2D(32,new KernelSize(10,10),new Strides(1,1),"same"));
        x6z.add(new MaxPooling2D(new PoolSize(2,2)));
        x6z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));
        x6z.add(new MaxPooling2D(new PoolSize(2,2)));
        x6z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        x1z.add(new Concatenate(x1a,x1b));
        x1z.add(new MaxPooling2D(new PoolSize(2,2)));
        x1z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        xp1z.add(new Concatenate(x1, x2));
        xp1z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        xp2z.add(new Concatenate(x2, x3));
        xp2z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        xp4z.add(new Concatenate(x3, x4));
        xp4z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        xp5z.add(new Concatenate(x2, x3));
        xp5z.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

        auxz.add(new Concatenate(x5, x6));
        auxz.add(new MaxPooling2D(new PoolSize(2,2)));
        auxz.add(new Conv2D(64,new KernelSize(5,5),new Strides(1,1),"same"));

		...
		x3a.add(new Conv2D(32,new Tuple(10,10),new Tuple(1,1),"same"));
		x3a.add(new MaxPooling2D(new Tuple(2,2)));
		x3a.add(new Conv2D(64,new Tuple(5,5),new Tuple(1,1),"same"));

		x3b.add(new Input(32,32,20));
		x3b.add(new Conv2D(32,new Tuple(10,10),new Tuple(1,1),"same"));
		x3b.add(new MaxPooling2D(new Tuple(2,2)));
		x3b.add(new Conv2D(64,new Tuple(5,5),new Tuple(1,1),"same"));
